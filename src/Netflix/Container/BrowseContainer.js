      ...
      <Header src='joker1' height='100vh'>
        <Header.Frame>
          <Header.Group>
            ...
            <Header.TextLink left='60px' active={category === 'series' ? 'true' : 'false'} onClick={() => setCategory('series')}>
              Series
            </Header.TextLink>
            ...
            <Cards.Frame>
              {items.data.map((names) => (
                <Cards.Item key={names.docId} item={names}>
                  <Cards.Images src={`/images/${category}/${names.genre}/${names.slug}/small.jpg`} />
                  <Cards.Info>
